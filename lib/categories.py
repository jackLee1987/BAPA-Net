...
#add jack 2025.10.18
SSDD_TRAIN = 'SSDD_train'
SSDD_TEST = 'SSDD_test'
SSDD_5SHOT = 'SSDD_5shot'
SSDD_10SHOT = 'SSDD_10shot'
SSDD_1SHOT = 'SSDD_1shot'

#add jack 2025.11.1
MLCD_TRAIN = 'MLCD_train'
MLCD_TEST = 'MLCD_test'
MLCD_10SHOT = 'MLCD_10shot'
MLCD_5SHOT = 'MLCD_5shot'
MLCD_1SHOT = 'MLCD_1shot'
#add jack 2025.11.1
UAV_TRAIN = 'UAV_train'
UAV_TEST = 'UAV_test'
UAV_10SHOT = 'UAV_10shot'
UAV_5SHOT = 'UAV_5shot'
UAV_1SHOT = 'UAV_1shot'

NWPU10_TRAIN = 'NWPU10_train'
NWPU10_TEST = 'NWPU10_test'
NWPU10_10SHOT = 'NWPU10_10shot'
NWPU10_5SHOT = 'NWPU10_5shot'
NWPU10_1SHOT = 'NWPU10_1shot'
...
SEEN_CLS_DICT = {
    ...
    NWPU10_TRAIN: ["ship","storage tank","basketball court","ground track field","habor","bridge","vehicle","aeroplane", "baseball diamond","tennis court"],
    NWPU10_TEST: ["ship","storage tank","basketball court","ground track field","habor","bridge","vehicle","aeroplane", "baseball diamond","tennis court"],
    NWPU10_5SHOT: ["ship","storage tank","basketball court","ground track field","habor","bridge","vehicle","aeroplane", "baseball diamond","tennis court"],
    NWPU10_1SHOT: ["ship","storage tank","basketball court","ground track field","habor","bridge","vehicle","aeroplane", "baseball diamond","tennis court"],
    NWPU10_10SHOT: ["ship","storage tank","basketball court","ground track field","habor","bridge","vehicle","aeroplane", "baseball diamond","tennis court"],
...
ALL_CLS_DICT = {
    ...
    NWPU10_TRAIN: ["ship", "storage tank", "basketball court", "ground track field", "habor", "bridge", "vehicle",
                   "aeroplane", "baseball diamond", "tennis court"],
    NWPU10_TEST: ["ship", "storage tank", "basketball court", "ground track field", "habor", "bridge", "vehicle",
                  "aeroplane", "baseball diamond", "tennis court"],
    NWPU10_5SHOT: ["ship", "storage tank", "basketball court", "ground track field", "habor", "bridge", "vehicle",
                   "aeroplane", "baseball diamond", "tennis court"],
    NWPU10_1SHOT: ["ship", "storage tank", "basketball court", "ground track field", "habor", "bridge", "vehicle",
                   "aeroplane", "baseball diamond", "tennis court"],
    NWPU10_10SHOT: ["ship", "storage tank", "basketball court", "ground track field", "habor", "bridge", "vehicle",
                    "aeroplane", "baseball diamond", "tennis court"],
    DIOR_10SHOT: ['Expressway-Service-area','Expressway-toll-station','airplane','airport','baseballfield','basketballcourt','bridge','chimney','dam', 'golffield', 'groundtrackfield', 'harbor', 'overpass', 'ship', 'stadium', 'storagetank', 'tenniscourt', 'trainstation', 'vehicle', 'windmill'],
    DIOR_TEST: ['Expressway-Service-area','Expressway-toll-station','airplane','airport','baseballfield','basketballcourt','bridge','chimney','dam', 'golffield', 'groundtrackfield', 'harbor', 'overpass', 'ship', 'stadium', 'storagetank', 'tenniscourt', 'trainstation', 'vehicle', 'windmill'],
    DIOR_5SHOT: ['Expressway-Service-area','Expressway-toll-station','airplane','airport','baseballfield','basketballcourt','bridge','chimney','dam', 'golffield', 'groundtrackfield', 'harbor', 'overpass', 'ship', 'stadium', 'storagetank', 'tenniscourt', 'trainstation', 'vehicle', 'windmill'],
