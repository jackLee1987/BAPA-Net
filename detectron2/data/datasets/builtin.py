...
_PREDEFINED_CD = [
    ...
    # add jack 2025.10.18
    ("SSDD_train", "SSDD/JPEGImages/train", "SSDD/annotations/train.json"),  #annotations小写
    ("SSDD_test", "SSDD/JPEGImages/test", "SSDD/annotations/test.json"),

    # add jack 2025.10.24
    ("NWPU10_train", "NWPU10/JPEGImages/train", "NWPU10/annotations/train.json"),  # annotations小写
    ("NWPU10_test", "NWPU10/JPEGImages/test", "NWPU10/annotations/test.json"),

    # add jack 2025.11.1
    ("MLCD_train", "MLCD/JPEGImages/train", "MLCD/annotations/train.json"),  # annotations小写
    ("MLCD_test", "MLCD/JPEGImages/test", "MLCD/annotations/test.json"),

    # add jack 2025.11.1
    ("UAV", "UAV/JPEGImages/train", "UAV/annotations/train.json"),  # annotations小写
    ("UAV_test", "UAV/JPEGImages/test", "UAV/annotations/test.json"),
]
...
for shot in [1, 5, 10]:
    ...
    # newly added jack 2025.10.18
    new_anns = ("SSDD_{}shot".format(shot),
                "SSDD/JPEGImages/train",
                "SSDD/annotations/{}_shot.json".format(shot))
    _PREDEFINED_CD.append(new_anns)

    # newly added jack 2025.10.23
    new_anns = ("NWPU10_{}shot".format(shot),
                "NWPU10/JPEGImages/train",
                "NWPU10/annotations/{}_shot.json".format(shot))
    _PREDEFINED_CD.append(new_anns)

    # newly added jack 2025.11.1
    new_anns = ("MLCD_{}shot".format(shot),
                "MLCD/JPEGImages/train",
                "MLCD/annotations/{}_shot.json".format(shot))
    _PREDEFINED_CD.append(new_anns)

    # newly added jack 2025.11.1
    new_anns = ("UAV_{}shot".format(shot),
                "UAV/JPEGImages/train",
                "UAV/annotations/{}_shot.json".format(shot))
    _PREDEFINED_CD.append(new_anns)


# # custom datasets
# datasets_name = ('dataset2',)#'dataset1', 'dataset3')#,'UODD', 'clipart1k', 'FISH', 'NEUDET', 'DIOR', 'UODD')
#
# _PREDEFINED_CD = []
